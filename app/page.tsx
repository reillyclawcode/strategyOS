    ...
    <main className="min-h-screen pb-20">
      ...
      <header className="pt-10 pb-8 px-4" style={{ background: "linear-gradient(180deg,rgba(245,158,11,0.06) 0%,transparent 100%)" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3 mt-5">
            ...
            <a href="https://climate-os.vercel.app/" target="_blank" rel="noopener" className="text-xs px-3 py-1.5 rounded-full" style={{ background: "rgba(16,185,129,0.12)", color: "#34d399", border: "1px solid rgba(16,185,129,0.3)" }}>{"\u{1F30D}"} ClimateOS</a>
            <a href="https://transition-os-beta.vercel.app/" target="_blank" rel="noopener" className="text-xs px-3 py-1.5 rounded-full" style={{ background: "rgba(56,189,248,0.12)", color: "#38bdf8", border: "1px solid rgba(56,189,248,0.3)" }}>{"\u{1F6E0}\uFE0F"} TransitionOS</a>
            ...
            <a href="https://civilization-os-3nlf.vercel.app/" target="_blank" rel="noopener" className="text-xs px-3 py-1.5 rounded-full" style={{ background: "rgba(6,182,212,0.12)", color: "#06b6d4", border: "1px solid rgba(6,182,212,0.3)" }}>{"\u{1F30D}"} CivilizationOS</a>
            <a href="https://simulation-brown.vercel.app/" target="_blank" rel="noopener" className="text-xs px-3 py-1.5 rounded-full" style={{ background: "rgba(244,63,94,0.12)", color: "#f43f5e", border: "1px solid rgba(244,63,94,0.3)" }}>{"\u{1F52C}"} Simulation</a>
      ...
      <footer className="mt-16 px-4 py-8 text-center text-xs" style={{ borderTop: "1px solid var(--card-border)", color: "var(--text-faint)" }}>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a href="https://climate-os.vercel.app/" target="_blank" rel="noopener" style={{ color: "#10b981" }}>{"\u{1F30D}"} ClimateOS</a>
          <a href="https://transition-os-beta.vercel.app/" target="_blank" rel="noopener" style={{ color: "#38bdf8" }}>{"\u{1F6E0}\uFE0F"} TransitionOS</a>
          <a href="https://civilization-os-ashy.vercel.app/" target="_blank" rel="noopener" style={{ color: "#8b5cf6" }}>{"\u{1F3DB}\uFE0F"} GovernanceOS</a>
          <a href="https://civilization-os-3nlf.vercel.app/" target="_blank" rel="noopener" style={{ color: "#06b6d4" }}>{"\u{1F30D}"} CivilizationOS</a>
          <a href="https://simulation-brown.vercel.app/" target="_blank" rel="noopener" style={{ color: "#f43f5e" }}>{"\u{1F52C}"} Simulation</a>
